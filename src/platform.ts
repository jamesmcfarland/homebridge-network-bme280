...
import { EnvironmentPlatformAccessory } from './platformAccessory';
 ...
 */
export class NetBMEHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    if (existingAccessory) {
      ...
      new EnvironmentPlatformAccessory(this, existingAccessory);
      ...
      new EnvironmentPlatformAccessory(this, accessory);
